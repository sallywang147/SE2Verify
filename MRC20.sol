...
/** 
    function hashEIP712MessageWithAddress(address add)
        internal
        view
...
contract BaseERC20 is ChildToken {
	...
	require(amount > 0);
        ...
        bytes32 dataHash = hashEIP712Message(
...
contract MRC20 is BaseERC20 {
    ...
    function buggy_test() public payable returns (uint256){
        currentSupply = 2;
